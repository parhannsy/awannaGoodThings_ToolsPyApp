"""
View: DashboardView
Halaman dashboard utama aplikasi dengan komponen modular.
"""
...
class DashboardView(ctk.CTkFrame):
    ...
    def _setup_ui(self):
        ...
        self.header = PageHeader(
            master=self,
            title="Dashboard",
            subtitle=f"Selamat datang di {self.config.APP_NAME}. Pusat kendali utama untuk mengolah data penjualan."
        )

        # Welcome Card
        welcome_card = ctk.CTkFrame(self, fg_color=("gray86", "gray17"), corner_radius=12)
        welcome_card.pack(fill="x", pady=(5, 10))
        ...
        # Upload Card
        upload_card = ctk.CTkFrame(self, fg_color=("gray86", "gray17"), corner_radius=12)
        upload_card.pack(fill="x", pady=(10, 0))
